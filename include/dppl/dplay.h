...
typedef struct {
  ...
  DWORD dwPlayerInfoMask;  //  A bit field that indicates which
                           ...
                           //      occupies 4 bytes.
                           //    PI (1 bit): MUST be set if the
                           //    ParentID field is present in the
                           //    structure.
                           //    SC (2 bits): MUST be set if the
                           ...
                           //      occupies 4 bytes.
                           //    X (21 bits): All bits with this label
