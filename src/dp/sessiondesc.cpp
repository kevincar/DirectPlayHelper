...
namespace dp {
sessiondesc::sessiondesc(std::shared_ptr<std::vector<BYTE>> message_data, BYTE *data)
    : message_data_(message_data),
      data_(data),
      session_(reinterpret_cast<DPSESSIONDESC2 *>(data)) {}

DWORD sessiondesc::get_size(void) {
  return this->session_->dwSize;
}
...
DWORD sessiondesc::get_session_id(void) {
  return this->session_->dpSessionID;
}
...
DWORD sessiondesc::get_reserved_2(void) {
  return this->session_->dwReserved2;
}
...
DWORD sessiondesc::get_user_1(void) {
  return this->session_->dwUser1;
}
...
DWORD sessiondesc::get_user_2(void) {
  return this->session_->dwUser2;
}
...
DWORD sessiondesc::get_user_3(void) {
  return this->session_->dwUser3;
}
...
DWORD sessiondesc::get_user_4(void) {
  return this->session_->dwUser4;
}
