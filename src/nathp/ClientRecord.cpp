...
namespace nathp
{
	...
	void ClientRecord::setData(unsigned char const* data, unsigned int const size) noexcept
	{
	...
	void ClientRecord::resetClientRecord(unsigned int const size) const noexcept
	{
		...
		this->_clientRecord = reinterpret_cast<_ClientRecord*>(new unsigned char[size]);
		return;
	}
	...
	void ClientRecord::setClientRecord(unsigned char const* data, unsigned int const size) noexcept
	{
