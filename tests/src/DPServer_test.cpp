...
TEST(DPServerTest, setClient) {
  int argc = 3;
  char const* argv[] = {"DPServer", "--client", "192.168.1.1"};
...
TEST(DPServerTest, setServerAndClient) {
  int argc = 3;
  char const* argv[] = {"DPServer", "--server", "--client"};
...
TEST(DPServerTest, setPort) {
  int argc = 5;
  char const* argv[] = {"DPServer", "--client", "192.168.8.8", "--port",
                        "2300"};
