...
TEST(ProxyTest, dp_initialization_host) {
  ...
  // proxy = std::make_shared<dppl::proxy>(&io_context,
  // dppl::proxy::type::peer, proxy_dp_callback, proxy_data_callback);
...
TEST(ProxyTest, dp_initialization_join) {
  ...
  // proxy = std::make_shared<dppl::proxy>(&io_context,
  // dppl::proxy::type::host, proxy_dp_callback, proxy_data_callback);
